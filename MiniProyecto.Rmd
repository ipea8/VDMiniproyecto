...
ui <- navbarPage(
  ...
  theme = shinythemes::shinytheme("flatly"),
    ...
    # Inyección de CSS para la leyenda y el cursor
  header = tags$head(
    tags$style(HTML("
  ...
  navbarMenu("Gráficas",
    ...
    tabPanel("Monumentos por Distrito",
      ...
      fluidPage(
        column(12,
          h2("Monumentos por Distrito"),
          p("Selecciona los tipos de monumentos que deseas visualizar."),
          checkboxGroupInput(
    ...
    tabPanel("Paradas por Distrito",
      ...
      fluidPage(
        column(12,
          h2("Paradas EMT por Distrito"),
          p("Número de paradas de la EMT en cada distrito de Valencia."),
    ...
    tabPanel("Lugares aislados",
      ...
      fluidPage(
        column(12,
          h2("Lugares Aislados"), # Título de la sección
          p("Consulta los puntos de interés que se encuentran a más de 300 metros de la parada de la EMT más cercana."),
...
server <- function(input, output, session) {
  ...
  output$mapa <- renderLeaflet({
    ...
    addLegend(
      position = "topright",
      colors = c("red", "magenta", "black", "purple", "orange", "pink", "blue"),
      labels = c("Parada EMT (Clicable)", "Iglesias", "Palacios/Museos", 
  ...
  # Renderizado de la tabla DT para los lugares aislados
